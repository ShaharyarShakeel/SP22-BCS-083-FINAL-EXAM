...
if(!malls){
  ...
  <View>
    <Image source={require('../assets/yellow.png')} style={{ width: 24, height: 24, marginBottom: 4 }} />
    <Text>Selected</Text>
  </View>
  <View style={{ marginHorizontal: 20 }}>
    <Image source={require('../assets/white.png')} style={{ width: 24, height: 24, marginBottom: 4 }} />
    <Text>Vacant</Text>
  </View>
  <View>
    <Image source={require('../assets/grey.png')} style={{ width: 24, height: 24, marginBottom: 4 }} />
    <Text>Occupied</Text>
  </View>
</View>
      ...
      {showPaymentOptions && (
        <View style={styles.paymentOptionsContainer}>
          <Pressable style={styles.paymentOption} onPress={() => handlePaymentOption("Bank")}>
            <Image source={require('../assets/bank.jpeg')} style={styles.paymentOptionImage} />
          ...
          <Pressable style={styles.paymentOption} onPress={() => handlePaymentOption("JazzCash")}>
            <Image source={require('../assets/jazzcash.jpg')} style={styles.paymentOptionImage} />
          ...
          <Pressable style={styles.paymentOption} onPress={() => handlePaymentOption("Easypaisa")}>
            <Image source={require('../assets/easypaisa.png')} style={styles.paymentOptionImage} />
